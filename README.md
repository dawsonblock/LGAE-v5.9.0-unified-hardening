...
[![Tests](https://img.shields.io/badge/tests-1214%20passing-brightgreen.svg)]()
...
## What is LGAE v5.10.0?

LGAE v5.10.0 is an **autonomous structural intelligence runtime** that unifies graph learning, geometric diagnostics, deterministic governance, cryptographic evidence, and offline RL into one authoritative cycle.
...
```bibtex
@software{lgae_v510,
  title  = {LGAE v5.10.0: Autonomous Structural Intelligence Runtime},
  author = {Dawson Block},
  year   = {2025},
...
**50 phases · 1214 tests · 0 regressions · Autonomous by design**
